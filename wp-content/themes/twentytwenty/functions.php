...
function test(){echo get_template_directory_uri() . '/assets/js/menu-script.js';}
add_action('wp_enqueue_scripts', 'my_register_script_method');

function my_register_script_method () {
    wp_enqueue_script( 'menu-script', get_template_directory_uri() . '/assets/js/menu-script.js', array ( 'jquery' ), 1.1, true);
}
